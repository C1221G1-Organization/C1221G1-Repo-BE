...
public interface IMedicineRepository extends JpaRepository<Medicine, String> {
    ...
    @Query(value = "select m.medicine_id, m.medicine_name, m.medicine_active_ingredients, m.medicine_import_price, m.medicine_retail_sale_profit, m.medicine_manufacture, m.medicine_usage, m.medicine_instruction, m.medicine_age_approved, m.medicine_image, m.medicine_description "
